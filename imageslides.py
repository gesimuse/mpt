...
DEFAULT_THEMES = [
    ...
    # --- 50 more, on explicit request for more activity variety. Same rule as the
    # first batch: caught mid-motion, never a held pose, and no "swimsuit" word for
    # any water activity (that reads as one-piece by convention even without the
    # literal phrase -- the operator preference test_one_piece_swimsuits_are_excluded
    # documents is about the GARMENT, not just the two banned words for it).
    {"vibe": "morning run through the city",
     "outfit": "wearing a fitted running tank and bike shorts",
     "location": "jogging along a riverside path at sunrise",
     "mood": "mid-stride, breathing hard, focused energy"},
    {"vibe": "pilates studio session",
     "outfit": "wearing a cropped tank top and high-waisted bike shorts",
     "location": "in a bright pilates studio, mirrors and mats",
     "mood": "mid-stretch on a reformer, focused breath"},
    {"vibe": "boxing gym workout",
     "outfit": "wearing a sports bra and fitted leggings, wrist wraps",
     "location": "in a gritty boxing gym, heavy bags hanging",
     "mood": "mid-punch at the bag, sweat and focus"},
    {"vibe": "rock climbing gym",
     "outfit": "wearing a fitted tank top and stretch climbing pants",
     "location": "at an indoor climbing gym, colorful holds",
     "mood": "reaching for a hold, arm extended, focused"},
    {"vibe": "beach volleyball",
     "outfit": "wearing a sporty two-piece bikini",
     "location": "on a sand volleyball court, net and ocean behind her",
     "mood": "mid-jump for the ball, sand kicking up"},
    {"vibe": "cycling through the hills",
     "outfit": "wearing a fitted cycling jersey and bike shorts",
     "location": "on a winding countryside road, bike beneath her",
     "mood": "leaning into a turn, wind in her hair"},
    {"vibe": "swimming laps",
     "outfit": "wearing a sporty two-piece swimsuit",
     "location": "at the edge of an outdoor lap pool, morning light",
     "mood": "pushing off the wall, water streaming off her"},
    {"vibe": "ice skating rink",
     "outfit": "wearing a fitted sweater and a short skater skirt",
     "location": "on an outdoor ice rink, string lights overhead",
     "mood": "mid-glide, arms out for balance, laughing"},
    {"vibe": "kickboxing class",
     "outfit": "wearing a cropped hoodie tied at the waist and leggings",
     "location": "in a sunlit kickboxing studio",
     "mood": "mid-kick, powerful stance, sweat glinting"},
    {"vibe": "trail running at dusk",
     "outfit": "wearing a fitted running top and shorts, hydration vest",
     "location": "on a forest trail as the light fades",
     "mood": "mid-stride over a root, focused and strong"},
    {"vibe": "sunday coffee on the balcony",
     "outfit": "wearing an oversized cardigan over a slip dress",
     "location": "on a small balcony, coffee cup in hand, plants around her",
     "mood": "leaning on the railing, quiet content smile"},
    {"vibe": "making the bed",
     "outfit": "wearing an oversized t-shirt, bare legs",
     "location": "in a sunlit bedroom, linens billowing",
     "mood": "mid-toss of a pillow, laughing candidly"},
    {"vibe": "vacuuming to music",
     "outfit": "wearing a cropped tank top and high-waisted shorts",
     "location": "in a bright modern living room",
     "mood": "mid-dance step, headphones on, carefree"},
    {"vibe": "watering the balcony plants",
     "outfit": "wearing a linen slip dress",
     "location": "on a plant-filled balcony at golden hour",
     "mood": "reaching up to a hanging pot, soft smile"},
    {"vibe": "ironing shirts",
     "outfit": "wearing an oversized unbuttoned shirt over shorts",
     "location": "in a sunlit laundry room",
     "mood": "glancing up mid-task, relaxed candid smile"},
    {"vibe": "unpacking groceries",
     "outfit": "wearing a cropped tank top and denim shorts",
     "location": "in a bright kitchen, grocery bags on the counter",
     "mood": "reaching into a bag, playful glance over her shoulder"},
    {"vibe": "breakfast in bed",
     "outfit": "wearing an oversized flannel shirt, bare legs",
     "location": "in a sunlit bedroom, a tray of breakfast on the sheets",
     "mood": "curled up, mid-laugh, relaxed morning light"},
    {"vibe": "organizing a bookshelf",
     "outfit": "wearing a cropped sweater and denim shorts",
     "location": "in a sunlit reading nook, shelves of books",
     "mood": "reaching for a book, focused candid moment"},
    {"vibe": "kayaking on a still lake",
     "outfit": "wearing a fitted rash guard and bikini bottoms",
     "location": "on a calm lake at sunrise, mountains reflected",
     "mood": "mid-paddle stroke, water dripping, focused"},
    {"vibe": "camping under the stars",
     "outfit": "wearing an oversized flannel and denim shorts",
     "location": "by a campfire at night, tent glowing behind her",
     "mood": "leaning toward the fire, warm candid smile"},
    {"vibe": "picking apples in an orchard",
     "outfit": "wearing a fitted tank top and overalls",
     "location": "in a sunlit apple orchard",
     "mood": "reaching for a branch, basket in hand, easy laugh"},
    {"vibe": "walking through a bamboo forest",
     "outfit": "wearing a flowing linen dress",
     "location": "on a path through a bamboo forest, dappled light",
     "mood": "mid-stride, hand trailing along a stalk"},
    {"vibe": "watching a sunset from a cliff",
     "outfit": "wearing a flowing sundress, windblown",
     "location": "on a coastal cliff edge at sunset",
     "mood": "hair whipping in the wind, awed candid expression"},
    {"vibe": "swimming in a waterfall pool",
     "outfit": "wearing a triangle bikini",
     "location": "at the base of a jungle waterfall",
     "mood": "mid-splash, water catching the light, laughing"},
    {"vibe": "foraging for mushrooms",
     "outfit": "wearing a fitted flannel and cargo shorts",
     "location": "in a misty pine forest",
     "mood": "crouched, basket in hand, focused candid moment"},
    {"vibe": "stargazing on a rooftop",
     "outfit": "wearing an oversized hoodie and leggings",
     "location": "on a city rooftop at night, blanket spread out",
     "mood": "lying back, looking up, relaxed and quiet"},
    {"vibe": "wandering a european old town",
     "outfit": "wearing a flowing sundress and sandals",
     "location": "on a cobblestone street lined with cafes",
     "mood": "mid-stride, glancing into a shop window"},
    {"vibe": "exploring a night market",
     "outfit": "wearing a fitted crop top and wide-leg pants",
     "location": "at a neon-lit night market, food stalls around her",
     "mood": "reaching for a snack, candid delighted smile"},
    {"vibe": "riding a scooter through the city",
     "outfit": "wearing a cropped jacket and a mini skirt",
     "location": "on a scooter at a city intersection, lights blurred",
     "mood": "hair blown back, confident grin"},
    {"vibe": "browsing a flea market",
     "outfit": "wearing a vintage slip dress",
     "location": "at an outdoor flea market, racks of clothes",
     "mood": "holding up a find, candid delighted laugh"},
    {"vibe": "reading on a train",
     "outfit": "wearing an oversized sweater and jeans",
     "location": "in a train car, countryside blurring past the window",
     "mood": "curled into the seat, absorbed, soft light"},
    {"vibe": "airport layover",
     "outfit": "wearing an oversized hoodie and leggings, sunglasses pushed up",
     "location": "at an airport gate, planes visible through the glass",
     "mood": "leaning against the window, relaxed candid moment"},
    {"vibe": "renting bikes on vacation",
     "outfit": "wearing a linen romper",
     "location": "on a coastal boardwalk, rental bikes beside her",
     "mood": "one foot on a pedal, laughing back at the camera"},
    {"vibe": "a rooftop pool at a resort",
     "outfit": "wearing a cut-out bikini",
     "location": "at a rooftop resort pool, city skyline behind her",
     "mood": "mid-step toward the water, candid easy smile"},
    {"vibe": "sunset sail on a catamaran",
     "outfit": "wearing a wrap bikini top and a sarong skirt",
     "location": "on the deck of a catamaran at sunset",
     "mood": "wind in her hair, leaning against the rail, easy smile"},
    {"vibe": "pottery wheel in a studio",
     "outfit": "wearing a clay-smudged apron over a fitted tank top",
     "location": "in a sunlit pottery studio, wheel spinning",
     "mood": "hands shaping clay, focused candid moment"},
    {"vibe": "photography walk with a film camera",
     "outfit": "wearing a fitted turtleneck and wide-leg trousers",
     "location": "on a city street, camera raised to her eye",
     "mood": "mid-shot, focused candid expression"},
    {"vibe": "flower arranging at a shop",
     "outfit": "wearing a linen apron over a fitted dress",
     "location": "in a flower shop, buckets of blooms around her",
     "mood": "arranging stems, focused candid smile"},
    {"vibe": "playing guitar on the porch",
     "outfit": "wearing an oversized band tee and denim shorts",
     "location": "on a porch swing at golden hour",
     "mood": "mid-strum, eyes closed, relaxed candid moment"},
    {"vibe": "sewing at a vintage machine",
     "outfit": "wearing a fitted blouse tucked into a skirt",
     "location": "at a sunlit sewing table, fabric scraps around her",
     "mood": "focused on the stitch, candid concentration"},
    {"vibe": "baking bread in a rustic kitchen",
     "outfit": "wearing a flour-dusted apron over a fitted top",
     "location": "in a rustic farmhouse kitchen",
     "mood": "kneading dough, flour on her hands, easy laugh"},
    {"vibe": "sketching in a park",
     "outfit": "wearing an oversized cardigan and leggings",
     "location": "on a park bench, sketchbook on her lap",
     "mood": "focused on the page, soft candid concentration"},
    {"vibe": "working at a coffee shop",
     "outfit": "wearing a cropped cardigan and high-waisted jeans",
     "location": "at a window table in a coffee shop",
     "mood": "mid-typing, glancing up, candid soft smile"},
    {"vibe": "rooftop cocktail party",
     "outfit": "wearing a slip dress with a thigh-high slit",
     "location": "at a rooftop party, string lights and skyline",
     "mood": "mid-laugh with a drink in hand, candid moment"},
    {"vibe": "live music at a small venue",
     "outfit": "wearing a cropped leather jacket and a slip dress",
     "location": "at a small concert venue, stage lights washing over the crowd",
     "mood": "mid-sway to the music, candid energy"},
    {"vibe": "birthday dinner at a restaurant",
     "outfit": "wearing a fitted satin dress",
     "location": "at a candlelit restaurant table",
     "mood": "mid-laugh, glass raised, candid warmth"},
    {"vibe": "karaoke night",
     "outfit": "wearing a sequin mini dress",
     "location": "in a dim karaoke bar, mic in hand",
     "mood": "mid-song, eyes closed, candid joy"},
    {"vibe": "first snow of the year",
     "outfit": "wearing an oversized puffer jacket over leggings",
     "location": "on a snow-dusted city street at dusk",
     "mood": "catching snowflakes, candid delighted laugh"},
    {"vibe": "spring bloom in the park",
     "outfit": "wearing a floral wrap dress",
     "location": "under blooming cherry trees in a park",
     "mood": "petals falling around her, candid soft smile"},
    {"vibe": "summer storm rolling in",
     "outfit": "wearing a linen sundress, wind catching the fabric",
     "location": "on a porch as storm clouds gather",
     "mood": "watching the sky, wind-blown hair, candid awe"},
]
...
SUBJECTS = [
    ...
    {"look": "bangladeshi", "desc": "bangladeshi woman in her mid twenties, long dark hair, warm brown skin"},
    {"look": "nepali", "desc": "nepali woman in her late twenties, dark hair, high cheekbones, warm skin"},

    # --- Southeast Asia. Distinct from, and outside, the Chinese/East Asian
    # appearance supervisor.ethnicity_excluded rejects -- see that gate's own
    # docstring ("appears Chinese or East Asian") for the exact, narrower scope this
    # is deliberately outside of. Vietnamese was left out of this batch: checkpoint
    # output for it measured too close to the excluded look often enough live to be
    # worth a second pass rather than guessing here. ---
    {"look": "filipina", "desc": "filipina woman in her mid twenties, long dark hair, warm tan skin"},
    {"look": "thai", "desc": "thai woman in her late twenties, dark hair, golden brown skin"},
    {"look": "indonesian", "desc": "indonesian woman in her mid twenties, long dark hair, warm brown skin"},
    {"look": "malaysian", "desc": "malaysian woman in her early thirties, dark hair, warm golden skin"},

    # --- More Caribbean, Central America, and the Pacific ---
    {"look": "jamaican", "desc": "jamaican woman in her late twenties, long braids, deep brown skin"},
    {"look": "haitian", "desc": "haitian woman in her mid twenties, natural curls, rich brown skin"},
    {"look": "guatemalan", "desc": "guatemalan woman in her early thirties, dark hair, warm bronze skin"},
    {"look": "costa-rican", "desc": "costa rican woman in her late twenties, dark wavy hair, sun-kissed skin"},
    {"look": "hawaiian", "desc": "hawaiian woman in her mid twenties, long dark hair, warm tan skin"},
    {"look": "fijian", "desc": "fijian woman in her late twenties, dark curls, deep brown skin"},

    # --- More Europe ---
    {"look": "croatian", "desc": "croatian woman in her mid twenties, dark hair, olive skin"},
    {"look": "slovak", "desc": "slovak woman in her late twenties, light brown hair, pale skin"},
    {"look": "finnish", "desc": "finnish woman in her early thirties, platinum blonde hair, pale blue eyes"},

    # --- More Middle East and Africa ---
    {"look": "iraqi", "desc": "iraqi woman in her late twenties, dark hair, warm olive skin"},
    {"look": "jordanian", "desc": "jordanian woman in her mid twenties, long dark hair, warm brown eyes"},
    {"look": "tanzanian", "desc": "tanzanian woman in her early thirties, short natural hair, deep brown skin"},
    {"look": "senegalese", "desc": "senegalese woman in her late twenties, braided updo, rich dark skin"},
    {"look": "zimbabwean", "desc": "zimbabwean woman in her mid twenties, natural curls, warm brown skin"},
